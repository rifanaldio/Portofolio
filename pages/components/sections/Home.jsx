...
const Home = () => {  
  ...
  const [animationDataThreedSpheres, setAnimationDataThreedSpheres] = useState(null);
    // Load file JSON dari /public pakai fetch
    useEffect(() => {
        fetch("/media/lotties/3dSpheres(Home).json")
            .then((res) => res.json())
            .then((data) => setAnimationDataThreedSpheres(data))
  ...
  return (
    <>
      <div className="pb-10 overflow-hidden sm1:pt-16 md:pt-0">
        {/* Desktop Home */}
        <div className="relative border-0 border-red-500 sm1:hidden md:block h-[50rem]">
          <div className="w-4/5 pt-20 m-auto border-0 border-red-500 opacity-1" id="main">
            <div className="z-0 text-2xl font-normal tracking-tighter text-white border-0 border-red-500 font-change2">
              <div className="absolute right-0 w-2/5 text-5xl border-0 border-red-500 sm1:hidden lg:block">
                <SafeLottie animationData={animationDataThreedSpheres} className="z-0 grayscale invert" loop={true}/>
              </div>
              ...
              <span className="text-blue-400 border-0 border-red-500 absolute top-[16.5rem] xl:left-[20.8rem] lg:left-[17.5rem] md:left-[14.2rem]">&nbsp;Rifan Aldio</span>
            </div>
            <div className="absolute z-10 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 top-[20rem] md:text-7xl sm3:text-7xl">FRONTEND</div>
            <div className="z-30 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 font-stencil2 top-[20rem] absolute md:text-7xl sm3:text-7xl">FRONTEND</div>
            <div className="absolute z-10 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 xl:top-[28rem] md:top-[25rem] lg:top-[26rem] md:text-7xl sm3:text-7xl"><span className="sm1:block md:inline">&nbsp;DEVELOPER</span></div>
            <div className="absolute z-30 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 font-stencil2 md:top-[25rem] xl:top-[27.95rem] lg:top-[26rem] md:text-7xl sm3:text-7xl"><span className="sm1:block md:inline">&nbsp;DEVELOPER</span></div>
          </div>
          ...
          <div className="absolute w-4/5 m-auto border-0 border-red-500 top-[2rem] lg:left-[9rem] xl:left-[10rem] md:left-[5rem] z-20">
            <img src="/media/images/meformal5.png" alt="" width={850} height={900} className="m-auto transition duration-300 transform grayscale"></img>
          </div>
          <div className="absolute z-40 md:w-1/3 lg:w-1/4 xl:w-1/5 text-sm text-white md:left-[5rem] md:top-[31.5rem] lg:top-[34.5rem] xl:top-[38rem] xl:left-[10rem] lg:left-[6.5rem] sm3:w-1/2 sm3:top-[20rem] sm3:left-[5rem]">I am a passionate and creative <span className="font-bold text-blue-400">Frontend Developer</span> with experience in creating highly polished Interfaces for the <span className="font-bold text-blue-400">web</span> & mobile</div>
          <div className="absolute z-30 flex space-x-3 lg:top-[35rem] xl:top-[38rem] md:right-8 xl:right-[10rem] md:top-[31rem]">
            <a href="https://github.com/rifanaldio" target="_blank" rel="noreferrer">
              <div className="text-white rounded-full sm1:text-xl md:text-2xl lg:text-3xl sm1:p-3 md:p-3 lg:p-3 hover:bg-white hover:text-black hover:scale-75 "><FiGithub /></div>
            </a>
            <a href="https://www.linkedin.com/in/rifan-aldio/" target="_blank" rel="noreferrer">
              <div className="text-white rounded-full sm1:text-xl md:text-2xl lg:text-3xl sm1:p-3 md:p-3 lg:p-3 hover:bg-white hover:text-black hover:scale-75 "><FaLinkedinIn /></div>
            </a>
        ...
        <div id="home" className="relative top-0 max-h-screen bg-cover border-0 border-red-500 sm1:block md:hidden">
          <div className="w-full pt-20 m-auto border-0 border-red-500 opacity-1" id="main">
            <div className="absolute w-2/5 text-5xl border-0 border-red-500 -right-4">
              <SafeLottie animationData={animationDataThreedSpheres} className="grayscale invert" loop={true}/>
            </div>
            ...
            <div className="relative z-10 sm3:w-11/12 w-full m-auto lg:-ml-4 border-0 border-red-500">
              <img src="/media/images/meformal5.png" alt="" width={850} height={800} className="m-auto transition duration-300 transform grayscale"></img>
            </div>
            <div className="absolute z-0 font-extrabold tracking-tighter text-center text-white font-change2 sm1:text-5xl left-3 sm1:top-[14rem] md:top-[17rem] sm2:top-[15rem] sm2:text-6xl sm2:left-0 sm3:left-8">FRONTEND</div>
            <div className="absolute z-20 font-extrabold tracking-tighter text-center text-white font-change2 font-stencil2 sm1:text-5xl left-3 sm1:top-[14rem] sm2:top-[15rem] md:top-[17rem] sm2:text-6xl sm2:left-0 sm3:left-8">FRONTEND</div>
          ...
          <div className="absolute z-40 w-11/12 text-sm text-white border-0 border-red-500 top-[28rem] sm3:left-[2rem] sm1:left-[1rem] sm1:hidden">Hello,I&apos;m <span className="font-bold text-blue-400">Rifan Aldio</span>,a passionate and creative <span className="font-bold text-blue-400">Frontend Developer</span> with experience in creating highly polished Interfaces for the <span className="font-bold text-blue-400">web</span> & mobile</div>
        ...
        <div id="projects" className="mt-56 border-0 border-red-500">
          <Projects />
        </div>
