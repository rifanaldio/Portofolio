  ...
  return (
    <div>
      <motion.div 
          ...
          <div className="mt-16 text-xl font-bold tracking-tighter text-center text-blue-400">Technical Proficiency</div>
                  ...
                  Skills.map((skill)=>{
                    return(
                      <div key={skill.id} className="flex flex-col space-x-8 border-0 border-red-500">
                        <img src={skill.url} alt="" width={150} height={150} className="p-2 invert-75 rounded-0 aspect-square"/>
