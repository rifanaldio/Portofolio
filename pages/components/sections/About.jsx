...
const About = () => {
    ...
    useEffect(() => {
        fetch("/media/lotties/FloatingYogaMan(About).json")
            .then((res) => res.json())
    ...
    return (
        <div className=' text-white'>
            <div className='w-2/3 m-auto border-0 border-red-500 md:text-sm sm1:text-xs fontwt'>
                <div className='border-0 border-red-500 xl:w-1/5 sm1:w-4/5 md:w-2/5'>Available for Freelance & Remote Jobs Frontend Developer</div>
            ...
            >
                <div className='border-0 border-red-500 xl:w-1/3 sm1:w-full sm1:text-sm md:text-md md:w-2/3'>
                    I am a self taught FRONTEND DEVELOPER with experience in creating digital interfaces, websites and have the ability to bring those concepts to life.
                </div>
            </motion.div>
            <div className='mt-24'>
                ...
                <div className='relative z-10 m-auto border-0 border-red-500 md:grid sm1:hidden md:grid-cols-2 xl:w-3/5 mt-28 sm1:w-2/3 md:w-3/4'>
                    ...
                    <div className='border-0 border-red-500 sm1:w-full md:text-sm sm1:mt-2 md:mt-0 sm1:text-xs xl:w-3/4'>
                        <div>I am currently working at PT Pegadaian. I have a solid professional experience for over four years. At the college level, I have worked on many practical projects as a member of the college programming community..</div>
                        <div className='md:mt-12 sm1:mt-4'>I have four years of experience as a Front-End Developer with the ability to bring concepts to life through creative front-end development. I enjoy everything related to product and visual design, mobile and web, as well as typography and animation.</div>
                    </div>
                </div>
            </div>
